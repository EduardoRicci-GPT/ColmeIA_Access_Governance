...
`npm run verificar` — **612 verificações, todas passando** neste repositório.

São 614 no checkout da Aletheia, e a diferença não é defeito: duas verificações
...
| Cenários hospitalares, exceções, competência e Explicar acesso | 155 |
